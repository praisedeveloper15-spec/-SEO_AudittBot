"""
Lightweight on-page SEO audit: fetches a URL and checks the fundamentals
SERP Robot-style tools flag (title, meta description, headings, images, etc).
"""
import requests
...
def audit_url(url: str) -> dict:
    ...
    try:
        ...
        pass  # robots.txt unreachable/absent — not fatal
